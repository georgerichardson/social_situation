...
class KnowItAll(Characteristic):
	...
	def intro1(self):
		...
		"You mention your job in passing and %s latches on, beginning to interject their opinion at every opportunity. Despite having little to no experience in your field, %s tells you with great authority about the issues with your line of work what they think you should do about them." % ch_name]
...
class Drunk(Characteristic):
	...
	def intro1(self):
		...
		intro = ["At first, %s seems interested in what you're talking about, but gradually you realise that their stare is vacant and they're just grinning, trying to nod at appropriate moments and not throw up. They've got no idea what you're talking about."  % (ch_name, ch_name),
		"Immediately, you realise your mistake. %s is tightly gripping their glass and swaying on the spot. You attempt to steady them, but they stagger forward and spill their drink on your shoes. They straighten up, apologise and start to tell you how great you are while tightly gripping your wrist." % (ch_name, ch_name)]
...
class Boring(Characteristic):
	...
	def intro1(self):
		...
		intro = ["Mere seconds pass before you realise your fatal mistake. %s\'s dullness hits you like a heatwave. How could someone possibly have so much to say about the quality of the road surfaces near their house? Time grinds to an excruciatingly slow pace and you enter into a trance like state." % (ch_name, ch_name),
